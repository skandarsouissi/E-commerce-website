    ...
    <div class="row text-center justify-content-center">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card shadow-lg rounded-4 border-0">
                <div class="card-body">
                    <h5 class="card-title text-primary mb-3">📦 Nombre des produits</h5>
                    <p class="display-5 fw-semibold text-dark"><?php echo $data['produit']; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card shadow-lg rounded-4 border-0">
                <div class="card-body">
                    <h5 class="card-title text-success mb-3">👥 Nombre des clients</h5>
                    <p class="display-5 fw-semibold text-dark"><?php echo $data['visiteur']; ?></p>
                </div>
            </div>
        </div>
    </div>
