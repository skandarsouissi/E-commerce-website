...
<div class="container-fluid">
  <div class="row">
  <?php include "../tamplate/navigation.php"      ?>
...
$i=0;
    foreach($categories as $c){
      ...
      <td>
        ...
        <a onclick="return popUpDeletCategorie()" href=" supprimer.php?idcategorie='.$c['id'].'"class="btn btn-danger">Supprimer</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="modifier.php" method="post">
          ...
          <div class="form-group"> 
            <input type="text" name="nom" class="form-control" value="<?php echo htmlspecialchars($categorie['nom']); ?>" placeholder="nom de categorie...">
          </div>
          <div class="form-group"> 
            <textarea name="description" class="form-control" placeholder="description de categorie..."><?php echo htmlspecialchars($categorie['description']); ?></textarea>
          </div>
      </div>
      <div class="modal-footer">
