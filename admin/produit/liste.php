...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="../../css/bootstrap.min.css" rel="stylesheet" integrity="sha384-SgOJa3DmI69IUzQ2PVdRZhwQ+dy64/BUtbMJw1MZ8t5HZApcHrRKUc4W0kG879m7">
  ...
  <div class="row">
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" href="../categories/liste.php">
                <svg class="bi" aria-hidden="true"><use xlink:href="#file-earmark"/></svg>
                Categories
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="../produit/liste.php">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="/admin/commandes/liste.php">
                <svg class="bi" aria-hidden="true"><use xlink:href="#graph-up"/></svg>
                commandes
              </a>
            </li>
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="../../deconnexion.php">
                <svg class="bi" aria-hidden="true"><use xlink:href="../../deconnexion.php"/></svg>
                Deconnexion
              </a>
            </li>
          </ul>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
     ...
     produit ajouté avec success
            ...
            }   // ajout = ok eli fel page ajout 7atineha fel url    ?>
  ...
  <tbody>
    ...
    foreach($produit as $i =>$p){
      ...
      <td>
        ...
        <a  onclick="return popUpDeletCategorie()"href=" supprimer.php?idproduit='.$p['id'].'"class="btn btn-danger">Supprimer</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group"> 
            <input type="number" name="prix"   required class="form-control" placeholder="prix de produit...">
        </div>
        <div class="form-group"> 
            <input type="file" name="image"   required class="form-control" placeholder="prix de produit...">
        </div>
...
<!-- Modal modifier -->
<?php
foreach ($produit as $produi) { 
?>
<div class="modal fade" id="editModal<?php echo $produi['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="modifier.php" method="post">
          <!-- Ajout du champ hidden pour l'ID  categeorie =id-->
          <input type="hidden" name="idproduit" value="<?php echo $produi['id']; ?>">
          <div class="form-group"> 
            <input type="text" name="nom" class="form-control" value="<?php echo htmlspecialchars($produi['nom']); ?>" placeholder="nom de produit...">
          </div>
          <div class="form-group"> 
            <textarea name="description" class="form-control" placeholder="description de produit..."><?php echo htmlspecialchars($produi['description']); ?></textarea>
          </div>
      </div>
      <div class="modal-footer">
